...
mod_news_ui <- function(id){
  ...
  tagList(
    ...
    bslib::layout_columns(col_widths = c(-1, 8, -3), fill = FALSE,
                          ...
                          bslib::accordion(open = c("tocome", "jul26"), # refers to 'value' of accordion_panel. !!update when adding entry!
                                           multiple = TRUE,
                                           ...
                                           # Juillet 2026
                                           bslib::accordion_panel(title = HTML("<strong>Juillet 2026</strong>"),
                                                                  value = "jul26",
                                                                  ...
                                                                  tagList(phosphoricons::ph(title = NULL, "arrows-clockwise", height = "1.5rem"),
                                                                          "Mise à jour des données de distribution d'électricité 2024 (+ correctif mineur années antérieures)"
                                                                  ),
                                                                  br(), br(),
                                                                  tagList(phosphoricons::ph(title = NULL, "arrows-clockwise", height = "1.5rem"),
                                                                          "Mise à jour des données de distribution de gaz naturel 2024 (+ correctif mineur années antérieures)"
                                                                  )
                                           ),
