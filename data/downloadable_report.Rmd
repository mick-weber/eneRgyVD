...
```{r}
# Temp removal : Yields error for params$web_width and params$web_height once rendered in stat-energie-vd.ch
params$prod_data |>
    eneRgyVD::create_bar_plotly(unit = params$unit,
                                n_communes = length(params$communes),
                                web_width = 1900, # manually defined
                                web_height = 1000, # manually defined
                                var_year = "annee",
                                var_commune = "commune",
