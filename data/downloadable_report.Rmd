...
Ce rapport a été généré depuis l'application [stat-energie-vd.ch](https://stat-energie-vd.ch/profil-energie) le `r paste0(format(Sys.Date(), "%d/%m/%Y")," à ", format(Sys.time(), "%H:%M"))` pour le(s) territoire(s) suivant(s) :
