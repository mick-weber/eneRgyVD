---
title: "Profil climatique des communes vaudoises"
...
params$elec_cons_data |>
    eneRgyVD::create_cons_table_dt(unit = params$energy_unit,
                                   DT_dom = "Bfrtip"
                                   )
...
params$elec_cons_data |>
    eneRgyVD::create_bar_plotly(unit = params$energy_unit,
...
params$elec_prod_data |>
    eneRgyVD::create_prod_table_dt(unit = params$energy_unit,
                                   DT_dom = "Bfrtip"
                                   )
```
...
params$regener_data_0 |>
  eneRgyVD::create_rg_needs_table_dt(unit = params$energy_unit,
                                    DT_dom = "Bfrtip"
                                    )
...
params$regener_data_1 |>
  eneRgyVD::create_regener_table_dt(energy_unit = inputVals$energyUnit,
...
params$regener_data_3 |> 
  eneRgyVD::create_rg_misc_table_dt(DT_dom = "Bfrtip") # Don't use params$energy_unit
```
